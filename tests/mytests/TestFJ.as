package mytests {
	...
	public class TestFJ extends TDNode {
		...
		private function onReady():void {
			...
			ASSERT_IS_NOT_NULL(fj.whenWorldUpdated, "Check whenUpdating");
			ASSERT_IS_NOT_NULL(fj.whenWorldDrawn, "Check whenDrawing");
			ASSERT_EQUAL(fj.whenWorldUpdated.numListeners, 0, "whenUpdating total");
			ASSERT_EQUAL(fj.whenWorldDrawn.numListeners, 0, "whenDrawing total");
