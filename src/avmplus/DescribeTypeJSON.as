...
package avmplus {
	...
	public class DescribeTypeJSON
	{
		...
		public function getInstanceProperties(type:Class):Object {
			return describeTypeJSON(type, INSTANCE_FLAGS
											^ INCLUDE_METHODS ^ INCLUDE_CONSTRUCTOR
											^ INCLUDE_METADATA ^ INCLUDE_INTERFACES
											^ INCLUDE_BASES ^ HIDE_OBJECT
			);
		}
